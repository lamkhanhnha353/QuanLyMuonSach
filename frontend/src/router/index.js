...
import DocGiaFavorites from "@/views/DocGiaFavorites.vue";
...
const routes = [
  // --- Luồng Public ---
  {
    ...
    children: [
      ...
      { path: "docgia/favorites", name: "docgia.favorites", component: DocGiaFavorites, meta: { requiresAuth: true, role: 'DocGia' } },
  ...
  // --- Luồng Staff (Nhân Viên) ---
  {
    ...
    children: [
      ...
      { path: "nhaxuatban", name: "staff.nhaxuatban", component: StaffNhaXuatBanManagement },
      // Tài khoản nhân viên
      { path: "account", name: "staff.account", component: NhanVienAccount },
